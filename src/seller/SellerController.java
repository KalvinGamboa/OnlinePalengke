...
public class SellerController {
    ...
    public void viewproducts(ActionEvent actionEvent) throws IOException {
        FXMLLoader firstLoader = new FXMLLoader(getClass().getResource("viewproducts.fxml"));
        Parent first = firstLoader.load();
        ViewProdcutsController viewProdcutsController = firstLoader.getController();
        viewProdcutsController.setSeller(getSellerstall());
        viewProdcutsController.getProducts();
    ...
    public void setproducts(ActionEvent actionEvent) throws IOException {
        ...
        setProductsController.setSellerstall(getSellerstall());
        Scene Scene = new Scene(first);
        Stage Stage =(Stage)((Node)actionEvent.getSource()).getScene().getWindow();
        Stage.setScene(Scene);
        Stage.show();
