...
public class PurchaseController extends stallprices {
    ...
    public static boolean quanavailable = true;
    public static String receipt_name = "";
    public static String usercontact = "";
    public Label stockswarning;
    ...
    public void checkquantity(){
        try {
            ...
            while (check.next()){
                if(check.getString("stall_name").equals(selectedstall.getText())){
                    System.out.println(check.getString("stall_name"));
                    ...
                    String sql2 = "select * from public."+check.getString("stall");
                    ResultSet check2 = sta2.executeQuery(sql2);
                    while (check2.next()){
                        if(productselected.toLowerCase().equals(check2.getString("product"))) {
                            quanavailable = Integer.parseInt(productquantity.getText()) < check2.getInt("stock");
                            System.out.println(quanavailable);
                        }
                    }
                }
            }
