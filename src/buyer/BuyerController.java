...
public class BuyerController extends stallprices{
    ...
    public void vieworderstatus(MouseEvent mouseEvent) throws IOException {
        getorderstatus();
        gettotal();
        if(status.equals("order received")||status.equals("order collected")||status.equals("delivering order")||status.equals("order secured")||status.equals("pending collector")) {
            ...
            if (status.equals("pending cpllector")) {
                orderStatusController.orderreceivedcomplete.setVisible(false);
            }
